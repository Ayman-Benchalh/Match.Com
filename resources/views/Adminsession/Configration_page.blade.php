    ...
    <div class="part1">
        ...
        <div class="list">
            <ul>
                ...
                <li id="focuseBnt"><a href="{{ route('Configration') }}">Setting</a></li>
            </ul>
        </div>
        <div class="btnlogout">
            <a href="#">LOG OUT</a>
        ...
        <div class="confirContent">
            <div class="Conifrparty1">
                <form action="" method="post">
                    ...
                    <input type="text" name="" placeholder="Ferst name">
                ...
                <div class="colletiobtn">
                            <label for="btnEdite" class="btnEdite">Edite Acount</label>
            ...
            <div class="Conifrparty2">
                ...
                <div class="cartConfig">
                    ...
                    <div class="cartPrix">50 &dollar;</div>
                    <div class="dateCart">
                        <ul>
                            <li>Date</li>
                            <li>2/12/2024</li>

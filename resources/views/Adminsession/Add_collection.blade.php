        ...
        <div class="titColl">
           ...
           <div class="insertFrom">
            <form action="{{route('store_product')}}" method="post">
                ...
                <input required type="text" name="sauvegarder" placeholder="sauvegarder">
                <input required type="number" name="prix" placeholder="prix">
        ...
        <div class="collectionExm">
            <div class="collec">
                ...
                <div class="partycoll1">
                    ...
                    <div class="qultyColl">save to 10%</div>
                </div>
            ...
            <div class="collec">
                ...
                <div class="partycoll1">
                    ...
                    <div class="qultyColl">save to 25%</div>
                </div>

            </div>
            <div class="collec">
                <div class="titleColl">6 month</div>
                <div class="partycoll1">
                    <div class="PriColl">26 &dollar;</div>
                    <div class="qultyColl">save to 55%</div>
                </div>

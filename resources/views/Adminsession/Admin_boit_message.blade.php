...
<div class="container">
  ...
  <div class="contentdash">
    ...
    <div class="part2">
        <div class="titleparty2">Configration</div>
        <div class="AdminBoitemessage">
            <div class="selectUser">
                <form action="" method="post">
                    <select name="selectUser" id="">
                        <option>choise user for contact as</option>
                        <option value="">Ayman benchalh Type_Abonne : 2 months</option>
                        <option value="">marouan benhmad Type_Abonne : 7 months</option>
                        <option value="">khalid slawi Type_Abonne : 12 months</option>
                        <option value="">salim monsori Type_Abonne : 36 months</option>
                    </select>
                </form>
            </div>

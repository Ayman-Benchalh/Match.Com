...
class GlobalController extends Controller
{
    ...
    public function insertAccount(){         
        ...
        public function login_Acount(Request $request){
            ...
            $values =['email'=> $email ,'password'=>$password ];
            if(auth()->guard('user')->attempt($values)){
                
             $data =  User::where('email',$email)->first();  
               
                // dd(Auth::guard('user')->user()->idUser);
             return redirect()->route('AllCollection',['idUser'=>$data->idUser]);
            }else{
